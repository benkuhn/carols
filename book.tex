...
% Use sections so that we can easily generate a TOC... but make them invisible
...
\addcontentsline{toc}{section}{Star in the East}
...
% \item Sherburne (While Shepherds Watched... shapenote version)
